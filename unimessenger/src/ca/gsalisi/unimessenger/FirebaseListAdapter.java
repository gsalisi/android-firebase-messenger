...
public abstract class FirebaseListAdapter<T> extends BaseAdapter {
	...
	private MessengerActivity main;
    ...
    d*/
    public FirebaseListAdapter(Query ref, Class<T> modelClass, int layout, MessengerActivity activity) {
        this.ref = ref;
        ...
        listener = this.ref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String previousChildName) {
                ...
                T model = (T) dataSnapshot.getValue(FirebaseListAdapter.this.modelClass);
    ...
    public void cleanup() {
        // We're being destroyed, let go of our listener and 
    	// forget about all of the models
